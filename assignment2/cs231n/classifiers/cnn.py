...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.normal(loc=0.0,scale=weight_scale,size=((num_filters*
                                                                              input_dim[1]//2*
                                                                              input_dim[2]//2),
                                                                              hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        z3, cache3 = affine_forward(a2, W3, b3)
        scores = z3
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        da2,grads['W3'],grads['b3'] = affine_backward(dz3, cache3)
